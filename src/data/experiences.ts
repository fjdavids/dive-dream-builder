...
export const experiences: Experience[] = [
  {
    ...
    category: 'snorkeling',
    meetingPoint: {
      en: 'Kanai or Grand Velas beach area',
      es: 'Área de playa Kanai o Grand Velas',
    },
    sections: {
      overview: {
  ...
  },
  {
    ...
    sections: {
      overview: { en: 'To be confirmed', es: 'Por confirmar' },
      itinerary: { en: 'To be confirmed', es: 'Por confirmar' },
      includes: { en: 'Seabob equipment, instruction', es: 'Equipo Seabob, instrucción' },
